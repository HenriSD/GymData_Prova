...
-- =============================================
-- Create
INSERT INTO usuarios (nome, email, senha) VALUES ('Novo Admin', 'novo@gymdata.com', '$2b$10$hash');
-- Read
...
-- =============================================
-- Create
INSERT INTO alunos (nome, email, cpf, telefone, data_nascimento, ativo)
  VALUES ('Teste Silva', 'teste@email.com', '999.999.999-99', '(11)99999-9999', '2000-01-01', true);
-- Read
...
-- =============================================
-- Create
INSERT INTO planos (nome, descricao, preco, duracao_dias, ativo)
  VALUES ('Plano Teste', 'Descrição', 99.90, 30, true);
-- Read
SELECT * FROM planos WHERE ativo = true ORDER BY preco;
SELECT * FROM planos WHERE id = 1;
-- Update
UPDATE planos SET preco = 109.90 WHERE id = 1;
-- Delete
...
INSERT INTO matriculas (aluno_id, plano_id, data_inicio, data_fim, status)
  VALUES (1, 2, '2025-06-01', '2025-06-30', 'ativa');
-- Read
...
-- =============================================
-- Create
INSERT INTO treinos (nome, aluno_id, observacoes)
  VALUES ('Treino Teste', 1, 'Obs de teste');
-- Read
SELECT t.*, a.nome AS aluno FROM treinos t JOIN alunos a ON a.id = t.aluno_id;
SELECT * FROM treinos WHERE id = 1;
-- Update
UPDATE treinos SET nome = 'Treino Atualizado' WHERE id = 1;
-- Delete
...
INSERT INTO exercicios (nome, grupo_muscular, descricao)
  VALUES ('Exercício Teste', 'Peito', 'Descrição do exercício');
-- Read
SELECT * FROM exercicios ORDER BY grupo_muscular, nome;
SELECT * FROM exercicios WHERE id = 1;
-- Update
UPDATE exercicios SET descricao = 'Descrição atualizada' WHERE id = 1;
-- Delete
